...
skill identifier (`SKILL_NAME`) for the functional-core-imperative-shell
eval suite. Everything else is re-exported from `skills/eval_utils`
so the underlying behaviour stays in one place.
...
SKILL_NAME = "functional-core-imperative-shell"
